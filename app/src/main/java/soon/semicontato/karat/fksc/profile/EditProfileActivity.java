package soon.semicontato.karat.fksc.profile;
...
public class EditProfileActivity extends AppCompatActivity implements View.OnClickListener, View.OnKeyListener {
    ...
    private static final int ADDING_NEW_PICTURE_REQUEST_CODE = 1;
        ...
        if (mAuth.getCurrentUser() != null) {
            ...
            try {
                ...
                if (name.equals(user.getFull_name()) && aboutMe.equals(userAboutMe.getAbout_me())
                        && curriculum.equals(userAboutMe.getCurriculum()) && imgURL == null) {
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.button_chooseProfilePhoto_editProfileLayout:
                ...
                startActivityForResult(intentShareActivity, ADDING_NEW_PICTURE_REQUEST_CODE);
                break;
     ...
     * E.G = EditProfileActivity --> ShareActivity (GalleryFragment) get imgURL
     * --> EditProfileActivity with imgURL information
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ADDING_NEW_PICTURE_REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                // Set the picture name to the EditProfile screen so the user can see
                ...
                mFileNameProfilePhoto.setText(imgURLLastName);
            }
        }
