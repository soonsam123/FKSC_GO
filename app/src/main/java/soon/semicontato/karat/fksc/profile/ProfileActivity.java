...
import soon.semicontato.karat.fksc.utils.RecyclerAdapterDojos;
    ...
    protected void onStart() {
        ...
        listener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Log.i(TAG, "onDataChange: 1) User and User_Settings: " + userAndUserSettings.toString());
                UserAboutMe userAboutMe = firebaseMethods.getUserAboutMe(dataSnapshot);
                Log.i(TAG, "onDataChange: 2) User About Me: " + userAboutMe.toString());
                ...
                Log.i(TAG, "onDataChange: 3) Dojo Info and Settings List: " + dojoInfoAndSettingsList.toString());
