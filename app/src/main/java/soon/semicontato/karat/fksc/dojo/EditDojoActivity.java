...
import soon.semicontato.karat.fksc.share.ShareActivity;
...
public class EditDojoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(soon.semicontato.karat.fksc.R.layout.activity_edit_dojo);
        ...
        if (mAuth.getCurrentUser() != null) {
            ...
            try {
                ...
                if (name.equals("") || city.equals("") || address.equals("")
                    ...
                    Toast.makeText(mContext, soon.semicontato.karat.fksc.R.string.must_fillin_all_fields, Toast.LENGTH_LONG).show();
                ...
                // Case 3) - *********** Users filled in all the fields. Good to go. ***********
                    ...
                    Toast.makeText(mContext, getString(soon.semicontato.karat.fksc.R.string.we_are_editing_your_dojo)
                    ...
                    if (imgURL != null) {
                        ...
                        // String dojo2 --> int (2)
                        int index = dojoNumber.lastIndexOf("o");
                        int dojoCount = Integer.parseInt(dojoNumber.substring(index + 1));

                        // Upload the picture to Firebase Storage.
                        firebaseMethods.uploadNewPhoto(mContext.getString(soon.semicontato.karat.fksc.R.string.photo_type_cover_photo_edit)
                                , imgURL, dojoCount);
                    }

                    Toast.makeText(mContext, soon.semicontato.karat.fksc.R.string.info_edit_success, Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(mContext, mContext.getString(soon.semicontato.karat.fksc.R.string.please_wait), Toast.LENGTH_SHORT).show();
            }
    ...
    private void setupWidgets(){
        ...
        // Buttons
        mButtonCoverPhoto = findViewById(soon.semicontato.karat.fksc.R.id.button_chooseCoverPhoto_editDojoLayout);

        // TextViews
        mTextViewChooseCoverPhoto = findViewById(soon.semicontato.karat.fksc.R.id.txtView_chooseCoverPhoto_editDojoLayout);
        mFileNameCoverPhoto = findViewById(soon.semicontato.karat.fksc.R.id.txtView_coverPhotoPath_editDojoLayout);

        // TextInputLayout and AppCompatEditText
        mEditTextDojoName = findViewById(soon.semicontato.karat.fksc.R.id.editText_dojoName_editDojoLayout);
        mEditTextCity = findViewById(soon.semicontato.karat.fksc.R.id.editText_city_editDojoLayout);
        mEditTextAddress = findViewById(soon.semicontato.karat.fksc.R.id.editText_address_editDojoLayout);
        mEditTextTelephone = findViewById(soon.semicontato.karat.fksc.R.id.editText_telephone_editDojoLayout);
        mEditTextDescription = findViewById(soon.semicontato.karat.fksc.R.id.editText_description_editDojoLayout);

        // Toolbar and features
        toolbar = findViewById(soon.semicontato.karat.fksc.R.id.toolBar_topBarEditDojoLayout);
        mBackButton = findViewById(soon.semicontato.karat.fksc.R.id.imgView_back_topBarEditDojoLayout);
        mAddButton = findViewById(soon.semicontato.karat.fksc.R.id.txtView_edit_topBarEditDojoLayout);

        // Layouts
        mRelativeLayoutContainer = findViewById(soon.semicontato.karat.fksc.R.id.relLayout_container_editDojoLayout);
        mRelativeLayoutContainer.setVisibility(View.GONE);

        mRelativeLayout_PleaseWait = findViewById(soon.semicontato.karat.fksc.R.id.relLayout_progressBar_snippetPleaseWait);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case soon.semicontato.karat.fksc.R.id.imgView_back_topBarEditDojoLayout:
                finish();
                break;
            case soon.semicontato.karat.fksc.R.id.txtView_edit_topBarEditDojoLayout:
                saveChanges();
                break;
            case soon.semicontato.karat.fksc.R.id.button_chooseCoverPhoto_editDojoLayout:
                ...
                intentShareActivity.putExtra(mContext.getString(soon.semicontato.karat.fksc.R.string.photo_type)
                        , mContext.getString(soon.semicontato.karat.fksc.R.string.photo_type_cover_photo_edit));
                startActivityForResult(intentShareActivity, UPLOAD_COVER_PHOTO);

                break;
            /*================== Hide the keyboard if the user click outside ==================*/
            case soon.semicontato.karat.fksc.R.id.txtView_chooseCoverPhoto_editDojoLayout: hideKeyBoard(); break;
            case soon.semicontato.karat.fksc.R.id.txtView_coverPhotoPath_editDojoLayout: hideKeyBoard(); break;
            case soon.semicontato.karat.fksc.R.id.relLayout_container_editDojoLayout: hideKeyBoard(); break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == UPLOAD_COVER_PHOTO) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                imgURL = data.getStringExtra(mContext.getString(soon.semicontato.karat.fksc.R.string.img_url));
    ...
    protected void onStart() {
        ...
        listener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                String userID = intentOrigin.getStringExtra(getString(soon.semicontato.karat.fksc.R.string.field_user_id));
                String dojoNumber = intentOrigin.getStringExtra(getString(soon.semicontato.karat.fksc.R.string.field_dojo_number));
