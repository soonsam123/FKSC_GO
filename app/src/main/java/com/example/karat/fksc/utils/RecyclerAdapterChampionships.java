        ...
        holder.linearLayout_eachItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView = ((ChampionshipActivity)mContext).getWindow().getDecorView()
                        .findViewById(R.id.relLayout_container_activityChampionship);

                // 2) Creates the snackbar.
                final Snackbar snackbar = Snackbar.make(rootView, R.string.contact_for_more_information, Snackbar.LENGTH_INDEFINITE);
                // 3) If the user clicks OK the snackbar will dismiss.
                snackbar.setAction(mContext.getString(R.string.ok), new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        snackbar.dismiss();
                    }
